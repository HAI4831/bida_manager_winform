...
UPDATE dbo.TableBida SET STATUS = N'Có người' WHERE id = 9
GO
...
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'Pessi', 1,64, 15000)
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'Coca', 1,108, 15000)
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'7Up', 1, 34, 15000)
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'Bò cụng', 1,1, 999999)
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'Mận', 2,2, 25000)
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'Ổi', 2,3, 20000)
INSERT dbo.Food
        ( name, idCategory,count, price)
VALUES  ( N'Nho', 2,4, 30000)
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'Thơm Thái', 2,6, 20000)
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'Dưa Hấu', 2,3, 18000)
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'Sài Gòn', 3,24, 30000)
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'Tiger', 3,205, 40000)
INSERT dbo.Food
        ( name, idCategory,count, price )
VALUES  ( N'Heniken', 2,1, 50000)
-- thêm bill
go
declare @i INT =1
While @i <=20
