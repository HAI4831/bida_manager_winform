...
namespace QuanLyBanBida
{
    ...
    {
        private string connect = "Data Source=localhost;Initial Catalog=QuanLyQuanBiDaFinal1;Integrated Security=True";
        ...
        private void txt_SearchTableName_TextChanged(object sender, EventArgs e)
        {
